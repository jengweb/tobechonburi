...
$db['read']['username'] = 'tobenumb_root';
$db['read']['password'] = '1qaz2wsx';
$db['read']['database'] = 'tobenumb_tobechonburi';
...
$db['write']['alias']    = 'dbw';
$db['write']['hostname'] = '27.254.96.158';
$db['write']['username'] = 'tobenumb_root';
$db['write']['password'] = '1qaz2wsx';
$db['write']['database'] = 'tobenumb_tobechonburi';
